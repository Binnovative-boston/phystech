...
<b><a href="https://phystech-2026.devpost.com/">Devpost page</a></b>
</p>
<p align="center">
<img src="images/poster26.jpg" width="350">
</p>
<p style="text-align: center;">
...
## Award Winners of PhysTech 2026:

**Grand Prix:**
- My Linh Pham Bui, [PhysTris: Combine Tetris with physical activities](https://devpost.com/software/phystris)

**2nd Place:**
- Hanna Suzuki, [Event-Driven Gain in Expectancy (EDGE): A Probabilistic Metric for Comprehensive Player Performance in Tennis](https://devpost.com/software/event-driven-gain-in-expectancy-edge)

**3rd Place:**
- Team VisionShaper; Cuong Bui, Minh Hong, and Lam Vu, [VisionForm AI Fitness](https://devpost.com/software/visionform)
- Konomi Karube, [HydroFlow Band](https://devpost.com/software/sweat-detector)

**Honorable Mention:**
- Alyssa Yasuhara, [Safety Run: Navigation device for runners](https://devpost.com/software/safety-run-navigation-device-for-runners)
...
- A publicly accessible link to your project placed on a cloud-based code repository (e.g. GitHub) or online storage (e.g. Google Drive). We will use this link to verify the actual outcome of your work and confirm its relevance to PhysTech. Please note that **we will not schedule your presentation if we cannot verify your actual work**. You may submit a link to your Devpost page; however, please make sure that the Devpost page points to the actual outcome of your work.
...
<tr>
    <td>Mug</td>
        <td><a href="https://www.bonfire.com/phystech-2026-mug/"><img src="images/26mug.jpg" width="150"></a>
        </td>
</tr>
<tr>
    <td>"Move Forward. Hack Beyond" T-shirts</td>
        <td><a href="https://www.bonfire.com/phystech-2026-move-forward-hack-beyond/"><img src="images/26-t-move.jpg" width="150"></a>
        </td>
</tr>
<tr>
    <td>"Hack What Moves You" T-shirts</td>
        <td><a href="https://www.bonfire.com/phystech-2026-clothing-apparel/"><img src="images/26-t-hack.jpg" width="150"></a>
        </td>
</tr>
<tr>
    <td>"Build Beyond" Pullover Hoodies</td>
        <td><a href="https://www.bonfire.com/phystech-2026-build-beyond/"><img src="images/26hoodie-build.jpg" width="150"></a>
        </td>
</tr>
<tr>
    <td>Logo Quarter Zip Pullovers</td>
        <td><a href="https://www.bonfire.com/phystech-2026-quarter-zip-pullover/"><img src="images/26qzippullover.jpg" width="150"></a>
        </td>
</tr>
<tr>
    <td>Logo Windbreakers</td>
        <td><a href="https://www.bonfire.com/2026-phystech-windbreaker160/"><img src="images/26windbreaker.jpg" width="150"></a>
        </td>
</tr>
</table>